...
export const meta = {
  ...
  lastEdited: '2019-04-20T10:25:57.000Z'
}
...
<Request
  method="POST"
  url="https://api.zeit.co/v2/oauth/access_token?client_id=oac_s4cllbR9Ao8307IDSkluOQBS&client_secret=EOBPvZuBYAtb3SbYo8H1iWFP&code=jMIukZ1DBCKXHje3X14BCkU0"
  headers={{
